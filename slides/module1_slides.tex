...
\begin{frame}{What Is the Terminal?}
...
\begin{frame}{What Changes When You Use Scripts}
  \textbf{No persistent state.} You cannot run one line, inspect the output, then run the next.\\
  Every time you run the file, it starts from scratch.

  \vspace{0.5em}
  \textbf{No intermediate output.} You cannot see what a dataframe looks like mid-pipeline unless you explicitly print or save it.
...
\begin{frame}{Setting Up a Virtual Environment}
