...
\begin{frame}[fragile]{\texttt{.gitignore} and \texttt{.claudeignore} Examples}
  \begin{columns}
...
# Large files (bloats history, wastes context)
*.csv.gz
...
__pycache__/
  ...
  \vspace{0.2em}
  {\tiny \textbf{Why exclude these:} Large files bloat git history (100MB file = slow commits forever). Python cache (\texttt{\_\_pycache\_\_/}, \texttt{.pyc}) is auto-generated and wastes Claude's read context.}
\end{frame}
