...
__pycache__/
  ...
  \textit{Note:} Patterns like \texttt{data\_merged.csv} match that filename in any subfolder. Use \texttt{data/data\_merged.csv} to match only within the \texttt{data/} folder.}
\end{frame}
