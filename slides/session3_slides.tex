...
\begin{frame}[fragile]{\LaTeX{} Workshop: Essential Commands}
  \textbf{Build and Preview (Mac):}
  \begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
Cmd+Alt+B    Compile to PDF
Cmd+Alt+V    Open PDF preview
  \end{lstlisting}

  \textbf{Build and Preview (Windows/Linux):}
  \begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
...
Ctrl+Alt+V   Open PDF preview
  ...
  \begin{itemize}
    \item Right-click the PDF preview tab
    \item Select \texttt{Move into Side Panel} to dock it on the right
