...
\begin{frame}{Exercise Part 1: Initialize and Commit (10 min)}
  Choose one:
  \begin{itemize}
    \item \textbf{Option A:} Work in your own research project directory
    \item \textbf{Option B:} Create a new directory (e.g., \texttt{session\_2\_git\_practice/}), copy your Session 2 code and data into it, and use that as a clean sandbox
  \end{itemize}
