...
\begin{frame}{Exercise Part 1: Initialize and Commit (10 min)}
  Choose one:
  \begin{itemize}
    \item \textbf{Option A:} Work in your own research project
    \item \textbf{Option B:} Use the provided Session 2 materials as a practice project (if you don't want to touch your own work)
  \end{itemize}
