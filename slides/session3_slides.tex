...
\begin{frame}{Exercise Part 1: Choose Your Project}
  ...
  \begin{itemize}
    \item Open your project folder in a \textbf{new VS Code window}: File → Open Folder
    \item Make sure you have all your Session 1--2 work inside
  \end{itemize}

  \vspace{0.5em}
  \textbf{Option B: Practice sandbox (recommended if you want to be cautious)}
  \begin{itemize}
    \item Create a new directory: \texttt{mkdir session\_2\_git\_practice}
    \item Copy your Session 2 code and data into it: \texttt{cp -r module\_2/* session\_2\_git\_practice/}
    \item Open it in VS Code: File → Open Folder → \texttt{session\_2\_git\_practice}
  \end{itemize}
