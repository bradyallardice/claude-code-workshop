...
\begin{frame}{Your Task This Week}
  \textbf{Take 60--90 seconds and jot down the most annoying or tedious computer-based task you worked on this week.}

  \vspace{0.5em}
  Just the task itself. Not how you did it. Examples:
  \begin{itemize}
    \item Copying numbers from a paper into a spreadsheet
    \item Re-running analysis with slightly different parameters
    \item Reformatting data to match a template
    \item Generating the same kinds of tables for different samples
  \end{itemize}

  \vspace{0.5em}
  We'll go around, hear what everyone's got, pick one to work through together, and I'll ask you to walk us through how you currently handle it.
\end{frame}

\begin{frame}{Understanding Your Workflow}
  \textbf{You're about to walk us through a task. I'm going to ask:}

  \begin{enumerate}
    \item ``What's the input? What are you starting with?''
    \item ``Where do you get stuck or it slows down?''
    \item ``What are you trying to produce at the end?''
    \item ``Is there any repetition in what you're doing?''
    \item ``What would you do differently if you had unlimited time?''
  \end{enumerate}

  \vspace{0.5em}
  These aren't trick questions. I'm genuinely trying to see the shape of the problem.
\end{frame}

\begin{frame}{Why We're Doing This}
  You came to this workshop because you're writing code to do research.

  \vspace{0.5em}
  Git, version control, and agentic workflows all serve the same purpose: \textbf{to make it safe and fast to change your code while keeping your work intact}.

  \vspace{0.5em}
  But they only matter if we're talking about \textit{your} work. Not abstractions.

  \vspace{0.5em}
  So we're going to see one of your actual workflows, and then I'll show you exactly where Claude Code and git fit into it.
\end{frame}
