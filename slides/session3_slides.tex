...
\begin{frame}[fragile]{\texttt{.gitignore} vs. \texttt{.claudeignore}}
  ...
  \begin{columns}
    ...
    \textbf{Paths are relative to that folder:}
...
my_project/
  ...
  output/
    ...
    \column{0.48\textwidth}
    \textbf{Example \texttt{.gitignore} file:}
    \begin{lstlisting}[basicstyle=\ttfamily\tiny]
# Paths (match folders)
data/raw/
output/
...
__pycache__/
  ...
  \vspace{0.1em}
  {\tiny \textbf{Always include in both:} \texttt{.env}, \texttt{.DS\_Store}, \texttt{*.pyc}, \texttt{*.log}, \texttt{*.aux}}
\end{frame}
