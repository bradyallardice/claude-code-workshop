...
\begin{frame}{Exercise Part 1: Initialize and Commit (10 min)}
  ...
  \begin{enumerate}
    \item {\small \textbf{Create a \texttt{.claudeignore}} FIRST:} In VS Code (File → New File) or terminal (\texttt{echo ".env" > .claudeignore}). Add \texttt{.env} and any other sensitive files.
