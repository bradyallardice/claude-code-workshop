...
.DS_Store
  ...
  \vspace{0.2em}
  \alert{Ask Claude Code to write a \texttt{.gitignore} for you.} It knows the common patterns.
\end{frame}
...
\begin{frame}{So Where Does the Data Go?}
  ...
  \begin{itemize}
    ...
    \item Your code lives in git. Your data lives next to it (or in a shared folder). Your \texttt{.gitignore} keeps them separate.
    \item This is simple, familiar, and good enough for most social science workflows
  \end{itemize}

  \vspace{0.5em}
  \textbf{For larger or more complex needs:}
  \begin{itemize}
    \item \textbf{Object storage:} AWS S3, Google Cloud Storage --- cheap, scalable, accessible from anywhere
