...
\begin{frame}{Check-In: Claude Code in Your Work}
  ...
  \vspace{0.5em}
  Either way is fine. I'm trying to understand where you are and what's actually blocking you from using it.
\end{frame}

\begin{frame}{What We Want to Know}
  \begin{itemize}
    \item \textbf{Usage:} Are you using Claude Code in your work at all?
