...
my_project/              <- run "git init" here
  ...
  code/
    analysis.py
  data/
    raw/                <- put in .gitignore but NOT .claudeignore
    processed/
...
\begin{frame}{Exercise Part 1: Initialize and Commit (10 min)}
  ...
  \begin{enumerate}
    ...
    {\tiny \alert{Important (Option B):} You will find a \texttt{.env} file with my real credentials. Exclude it immediately.}
    ...
    {\tiny Note: \texttt{.claudeignore} uses the same syntax.}
