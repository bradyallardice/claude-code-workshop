...
\begin{frame}{Exercise Part 3: Build a \LaTeX{} Document (30 min)}
  ...
  \begin{itemize}
    ...
    \item \textbf{Option B:} Use the \textbf{provided project} (\texttt{module\_3/}) with data, scripts, and the robustness table from Session 2
  \end{itemize}

  \vspace{0.5em}
  \textbf{Your goal:} Build out three sections of a paper ---
  \textbf{Data}, \textbf{Methods}, and \textbf{Results}.
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item A \textbf{Data} section describing your variables and sample
      \item A \textbf{Methods} section explaining your empirical approach
      \item A \textbf{Results} section pulling in tables via \texttt{\textbackslash input\{...\}} and figures via \texttt{\textbackslash includegraphics\{...\}}
    \end{itemize}

    \vspace{0.2em}
    \item \textbf{Compile} to PDF and verify it renders correctly (fix errors with Claude Code)

    \vspace{0.2em}
    \item \textbf{Diff and commit} the new file

    \vspace{0.2em}
    \item \textbf{Ask Claude Code} to check the data and methods sections against your actual code. Does the text match what the code does?
  \end{enumerate}
