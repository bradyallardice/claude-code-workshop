...
\begin{frame}{Exercise Part 1: Initialize and Commit (10 min)}
  ...
  \begin{enumerate}
    ...
    {\small \textbf{Bonus:} If you're in your own project and want Claude Code to ignore certain files, create a \texttt{.claudeignore} file using the exact same syntax. Works the same way.}
