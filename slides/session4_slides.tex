...
\begin{frame}{Coming Next Session}
  ...
  \vspace{0.6em}
  \hspace{2em}\textbf{3. The final project} --- two-person teams in the same GitHub collaboration repo, reading an unfamiliar paper, using Zotero for the literature review, then writing a short replication + extension note.
  \end{flushleft}
\end{frame}
...
\begin{frame}{Next Session + Prework}
  ...
  \begin{itemize}
    ...
    \item \textbf{Final project} --- two-person teams in \texttt{github\_collaboration\_practice}: paper familiarization, Zotero-backed literature review, replication, extension, and reflection
  \end{itemize}

  \vspace{0.8em}
  \textbf{Before next session:}
  \begin{enumerate}
    \item \textbf{Make sure you still have access to \texttt{github\_collaboration\_practice}} and that the Zotero MCP works; Session 5 imports \texttt{zotero/capstone\_library.bib} with attached PDFs from \texttt{zotero/pdfs/}
