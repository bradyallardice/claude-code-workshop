...
\begin{frame}{Your Chapter}
  \textbf{Claim a chapter slot.} Open \texttt{CHAPTERS.md} at the root of the class repo and put your name next to one of the 16 numbered slots. First come, first served.
  ...
  \begin{itemize}
    ...
    \item Approve and merge your own PR (no branch protection here)
  \end{itemize}
