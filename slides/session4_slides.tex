...
% ---- 2a: The honest admission -----------------------------------

\begin{frame}{Starting With an Admission}
  \textbf{I have built four skills:}

  \vspace{0.6em}
  \begin{itemize}
    \item \texttt{auto-commit}
    \item \texttt{research-docs}
    \item \texttt{robustness-checks}
    \item \texttt{spec-validator}
  \end{itemize}

  \vspace{0.8em}
  \textbf{I barely use any of them.}

  \vspace{0.8em}
  \alert{I'm not teaching you an aspiration. I'm teaching you what I learned from building four things I don't use.}
\end{frame}
...
git push -u origin chapter-N
    ...
    \begin{itemize}\small
      \item Click the banner on GitHub, base \texttt{main}, assign your partner
    ...
    \vspace{0.4em}
    \alert{You are not grading. Approve and merge.}
  \end{columns}

  \vspace{0.5em}
  \begin{block}{Time budget (\textasciitilde{}15 min total)}
    Vote: 1 min \quad|\quad Draft: 5 min \quad|\quad PR + review + merge: 4--6 min \quad|\quad Assemble: 2 min
  \end{block}
\end{frame>
