...
\begin{frame}{Coming Next Session}
  ...
  \vspace{0.6em}
  \hspace{2em}\textbf{3. The final project} --- a short replication + extension note, plus a reflection on which AI workflow pieces actually transfer to your own work.
  \end{flushleft}
\end{frame}
...
\begin{frame}{Next Session + Prework}
  ...
  \begin{itemize}
    ...
    \item \textbf{Final project} --- a replication + extension note, with a workflow reflection on prompts, skills, subagents, and hooks
  \end{itemize}
