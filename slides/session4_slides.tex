...
...
    ...
    \begin{enumerate}\small
      ...
      \item When a task matches the description, Claude invokes the skill
    ...
    \begin{block}{\small The key idea}
      \small The \texttt{description} is the trigger. Write it so Claude can tell \emph{when} this skill applies.
    \end{block}
  \end{columns}
\end{frame}
