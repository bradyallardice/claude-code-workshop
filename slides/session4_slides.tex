...
\begin{frame}
  ...
  \vspace{1em}
  {\Large The whole collaboration loop,\\[0.2em] once through with a tiny chapter.}

  \vspace{2em}
  {\small Watch the branch get created, pushed, opened as a PR,\\
  reviewed, and merged --- then see what happens to \texttt{main}.}
\end{frame}
...
\begin{frame}{Exercise: The Collaborative Story}
  ...
  \vspace{0.8em}
  \textbf{The setup is already on \texttt{main}.} I've pushed a \texttt{README} with the premise, a cast of named characters, and a \texttt{chapters/} folder. You \texttt{clone} the repo, then work from there.
