...
\begin{frame}{MCP as Helper, Not Substitute}
  ...
  \begin{itemize}\small
    \item \textbf{Branch protection} on \texttt{main} requiring a human review. The MCP obeys it --- same API as the UI.
  ...
  \vspace{0.2em}
  \alert{\small The exercise \emph{asked for} two humans --- that was a convention, not a GitHub rule. By default, anyone with write access (including Claude via the MCP) can merge a PR alone. Branch protection is what actually makes review mandatory.}
\end{frame}
