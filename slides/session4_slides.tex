...
cd ~/my_workspace/session_4 && code .
  ...
  \begin{alertblock}{If it says it can't find the path or rejects \texttt{\textasciitilde}}
    {\small \textbf{Type these by hand --- don't paste from the slides.} Pasting can turn \texttt{\textasciitilde} and \texttt{\_} into look-alikes the shell rejects, and \texttt{mkdir} (step~2) is what creates \texttt{\textasciitilde/my\_workspace}. No spaces in the names.}
  \end{alertblock}

  \vspace{0.2em}
  \centerline{\small \textbf{On Windows? Use the PowerShell version on the next slide.}}
\end{frame}
