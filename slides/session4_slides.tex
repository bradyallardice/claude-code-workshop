...
\begin{frame}[fragile]{What Is a Pull Request?}
  ...
  \vspace{0.3em}
  \textbf{What a PR page gives you:}
  \begin{itemize}\small
    \item A diff of every change on the branch (\textbf{Files changed})
    \item A conversation thread for review, questions, requested changes
    \item An approve-and-merge button guarded by the reviewer
  \end{itemize}

  \vspace{0.2em}
  \alert{\small Nothing in \texttt{main} changes until someone clicks Merge. The PR is the gate.}
\end{frame}
