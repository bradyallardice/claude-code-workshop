  ...
  \begin{lstlisting}
{
  ...
  \vspace{0.6em}
  \textbf{The honest version:} on emerging tools, multiple paths look reasonable and each has gaps. Know the gaps, combine with care. We'll see a stronger mechanism later when we cover \alert{hooks}.
\end{frame}
