...
\begin{frame}{Next Session + Prework}
  ...
  \begin{enumerate}
    \item \textbf{Make sure you still have access to \texttt{github\_collaboration\_practice}} and that the Zotero MCP works; Session 5 uses \texttt{zotero/capstone\_library.bib} as the import seed
