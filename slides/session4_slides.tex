...
\begin{frame}{\ldots Now You're Going to Write the Story}
  ...
  \vspace{0.6em}
  Each of you takes one chapter, featuring the cast I just pushed. Your partner reviews and merges your PR. At the end, we assemble all chapters and read the story out loud.
...
\begin{frame}{Coming Next Session}
  ...
  \vspace{0.6em}
  \hspace{2em}\textbf{3. The final project} --- an end-to-end research artifact built with everything from Sessions 1--4, plus what you learn on day one of Session 5.
  \end{flushleft}
\end{frame}
