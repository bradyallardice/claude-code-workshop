...
\begin{frame}{MCP as Helper, Not Substitute}
  ...
  \begin{itemize}\small
    \item \textbf{Turn on branch protection} --- a GitHub setting (Repo $\rightarrow$ Settings $\rightarrow$ Branches) that refuses to merge a PR unless it has at least one human approval. The MCP has to obey it, same as the web UI.
