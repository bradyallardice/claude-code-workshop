...
\begin{frame}{The Structural Fix}
...
[... full instructions ...]
  ...
  \vspace{0.3em}
  \textbf{The description is what earns the skill its load.} Claude Code reads the description on every turn and decides whether this skill is relevant to what you're doing.
...
\begin{frame}{Marginal Case: \texttt{research-docs}}
  ...
  \begin{itemize}
    \item \emph{Fresh-prompt counterfactual:} could I just say ``log this decision in the codebook''? Mostly yes.
    \item \emph{Domain knowledge?} A little --- knows what belongs in a codebook vs. a README. Not much.
  ...
  \vspace{0.5em}
  \textbf{Thinking out loud:} this is probably a \emph{format} skill pretending to be a workflow one. It might earn its keep if I used it religiously. I don't. So right now, it's closer to dead weight than to infrastructure.

  \vspace{0.4em}
  \begin{alertblock}{Honest verdict}
    Not sure. Leaning: demote to a CLAUDE.md paragraph and a habit. I'd rather have three skills I use than ten I built.
  \end{alertblock}
\end{frame}
