...
\begin{frame}{Coming Next Session}
  ...
  \vspace{0.6em}
  \hspace{2em}\textbf{3. The final project} --- two-person teams create an empty GitHub repo, copy in \texttt{capstone-template/}, read the paper, use Zotero, then write a short replication + extension note.
  \end{flushleft}
\end{frame}
...
\begin{frame}[shrink=10]{Next Session + Prework}
  ...
  \begin{itemize}
    ...
    \item \textbf{Final project} --- two-person teams create an empty GitHub repo, copy in \texttt{capstone-template/}, then do paper familiarization, Zotero-backed literature review, replication, extension, and reflection
  \end{itemize}
