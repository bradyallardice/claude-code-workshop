...
\begin{frame}{Where We Are}
  ...
  \begin{enumerate}
    ...
    \item Build a skill --- and learn to route a wish: is it a \textbf{skill}, \textbf{project context}, or \textbf{MCP}?
  \end{enumerate}
...
\begin{frame}{Part 2: MCPs}
  ...
  \vspace{1.5em}
  {\small An MCP is for what's \emph{live} --- a system that changes outside your project.\\
...
% ══════════════════════════════════════════════════════════════════
%  PART 3: SKILLS (CENTERPIECE)
% ══════════════════════════════════════════════════════════════════

\begin{frame}{Part 3: Skills}
  \centering
  \vspace{0.5em}
