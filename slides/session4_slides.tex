...
\begin{frame}{Where Would This Reduce Friction for You?}
  ...
  \vspace{1em}
  \begin{alertblock}{You already installed it}
    The Zotero MCP setup was in your Session 4 prework. If you completed it, the demo you just saw runs on your machine too --- try the same prompt against your own library after class.
  \end{alertblock}
\end{frame}
