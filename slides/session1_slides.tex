...
\begin{frame}{What Belongs in CLAUDE.md}
  ...
  \vspace{0.4em}
  {\small Keep the \textit{user-level} CLAUDE.md for things that apply across projects. Use a \textit{subfolder} CLAUDE.md only when a directory needs its own rules.}
