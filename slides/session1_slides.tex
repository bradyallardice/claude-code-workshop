...
\begin{frame}{Same Claude Code, Different Front Doors}
  ...
  \begin{tabular}{@{}p{0.27\textwidth} p{0.66\textwidth}@{}}
    ...
    \midrule
    \textbf{Terminal (CLI)} & The core experience. Run \lstinline{claude} in any project folder. Full agent, full control --- what we use in this course. \\[0.3em]
    \textbf{VS Code / JetBrains} & The same agent inside your editor. Inline diffs, click-to-open file references, your code and Claude side by side. \\[0.3em]
