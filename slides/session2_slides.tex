...
\begin{frame}[fragile]{Start-of-Session Ritual}
  \textbf{Same as session 1:} work on a copy, not inside the shared repo. Do this now:
...
\begin{frame}{Validation Strategy 2: Check Known Properties}
  ...
  \vspace{0.5em}
  \textbf{In VS Code:} When working directly in the editor, you see the \texttt{git diff} before you accept the change. This shows exactly what Claude Code changed.
\end{frame}
