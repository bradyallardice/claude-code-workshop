...
This is a teaching repository for a workshop on using Claude Code in academic research. Each `session_N/` folder contains exercises and demo data for that session.
...
- Use hardcoded relative paths from the project root (e.g., "session_1/data/") instead of __file__-based paths
