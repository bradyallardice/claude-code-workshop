...
Please complete \textbf{all seven steps} below before the workshop. The entire process takes 30--50 minutes. If you get stuck on any step for more than 10 minutes, stop and email me at \href{mailto:brady.allardice@upf.edu}{brady.allardice@upf.edu} --- don't try to debug it yourself. Once you are done, run the verification commands at the end and \textbf{send me a screenshot} of the output.
