...
\begin{itemize}[leftmargin=2em,itemsep=0pt]
  ...
  \item Open the Zotero desktop app (or the web library) and confirm you have \textbf{at least 5--10 items} in your library --- if your library is empty, the demo has nothing to search. If it is, drag a few PDFs in or use the browser connector to grab a handful of papers
\end{itemize}

\subsection*{5b. Get your Zotero API key and Library ID}
