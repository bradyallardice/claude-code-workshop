...
If it returns a list of titles you recognize, you are done. \textbf{Make sure the Zotero desktop app is open} when you run this --- if it isn't, the MCP will either fail or fall back to the (slower) Web API.
