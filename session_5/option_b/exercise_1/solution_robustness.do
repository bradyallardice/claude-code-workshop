...
* ── Load merged data ─────────────────────────────────────────────
import delimited "option_b/output/merged_survey.csv", clear varnames(1)
...
esttab m1 m2 m3 m4 m5 m6 using "option_b/exercise_2/tables/robustness_table.tex", ///
    replace                                               ///
    label booktabs                                        ///
    b(%9.3f) se(%9.3f)                                    ///
    star(* 0.10 ** 0.05 *** 0.01)                         ///
...
di _n "LaTeX table saved to option_b/exercise_2/tables/robustness_table.tex"
