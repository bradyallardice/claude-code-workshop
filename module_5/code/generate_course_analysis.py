...
# Save raw data
df.to_csv('module_5/data/course_participants.csv', index=False)
satisfaction_df.to_csv('module_5/data/satisfaction.csv', index=False)
...
plt.tight_layout()
plt.savefig('module_5/paper/figures/enrollment.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('module_5/paper/figures/satisfaction.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('module_5/paper/figures/attrition.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('module_5/paper/figures/earnings_effect.png', dpi=300, bbox_inches='tight')
plt.close()
...
print(f"  • 1 summary statistics table PNG in module_5/paper/figures/")
print(f"\nData files:")
