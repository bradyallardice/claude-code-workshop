...
* ── Load survey data ─────────────────────────────────────────────
import delimited "module_5/option_b/data/swiss_franc_survey.csv", clear varnames(1)
di "Survey observations: " _N
tempfile survey_tmp
save `survey_tmp'

* ── Load demographics data ───────────────────────────────────────
import delimited "module_5/option_b/data/respondent_demographics.csv", clear varnames(1)
...
* ── Save ─────────────────────────────────────────────────────────
export delimited using "module_5/option_b/output/merged_survey.csv", replace
di _n "Saved merged data to module_5/option_b/output/merged_survey.csv"
