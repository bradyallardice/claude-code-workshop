...
# ── Load data ────────────────────────────────────────────────────
survey = pd.read_csv("session_4/option_b/data/swiss_franc_survey.csv")
demog = pd.read_csv("session_4/option_b/data/respondent_demographics.csv")
...
# ── Save ─────────────────────────────────────────────────────────
merged.to_csv("session_4/option_b/output/merged_survey.csv", index=False)
print("\nSaved merged data to session_4/option_b/output/merged_survey.csv")
