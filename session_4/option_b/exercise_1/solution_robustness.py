...
# Save LaTeX table
with open("session_4/option_b/exercise_2/tables/robustness_table.tex", "w") as f:
    f.write(latex_output)

print("\n\nLaTeX table saved to session_4/option_b/exercise_2/tables/robustness_table.tex")
print("\n" + latex_output)
