...
# ── Load data ────────────────────────────────────────────────────
survey <- read_csv("session_4/option_b/data/swiss_franc_survey.csv")
demog  <- read_csv("session_4/option_b/data/respondent_demographics.csv")
...
# ── Save ─────────────────────────────────────────────────────────
write_csv(merged, "session_4/option_b/output/merged_survey.csv")
